...
<div class="bg-secondary text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-gray-300">Kami senang mendengar dari Anda. Hubungi kami untuk reservasi atau pertanyaan.</p>
    </div>
</div>
            ...
            <div class="md:col-span-2 bg-white p-10 rounded-2xl shadow-lg">
                ...
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="subject" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-primary focus:border-primary transition" placeholder="Pertanyaan Reservasi" required>
                    </div>
                    <div>
